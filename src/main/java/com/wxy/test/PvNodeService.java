...
public class PvNodeService {
    ...
    public void createPvNode(PvNode node) {
        ...
        jdbcTemplate.update("INSERT INTO pvnoderpt(devAddr,voltage,temperature,relaySate,`signal`,time) VALUES (?,?,?,?,?,?)",node.devAddr,node.voltage,node.temperature,node.relaySate,node.signal,
